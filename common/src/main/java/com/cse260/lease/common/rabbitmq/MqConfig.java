...
public class MqConfig implements EnvironmentAware{
    ...
    SimpleRabbitListenerContainerFactory simpleRabbitListenerContainerFactory(
        ...
        factory.setAfterReceivePostProcessors(message -> {
            Object header = message.getMessageProperties().getHeader(MqConstants.REQUEST_ID_HEADER);
            if(header != null) {
                MDC.put(MqConstants.REQUEST_ID_HEADER, header.toString());
            }
            return message;
        });
        return factory;
    ...
    public MessageRecoverer republishMessageRecoverer(RabbitTemplate rabbitTemplate){
        ...
        return new RepublishMessageRecoverer(
                rabbitTemplate, MqConstants.ERROR_EXCHANGE, defaultErrorRoutingKey);
    }
    ...
    public DirectExchange errorMessageExchange(){
        return new DirectExchange(MqConstants.ERROR_EXCHANGE);
    }
    ...
    public void setEnvironment(Environment environment) {
        ...
        this.defaultErrorRoutingKey = MqConstants.ERROR_KEY_PREFIX + appName;
        this.defaultErrorQueue = StrUtil.format(MqConstants.ERROR_QUEUE_TEMPLATE, appName);
    }
}
