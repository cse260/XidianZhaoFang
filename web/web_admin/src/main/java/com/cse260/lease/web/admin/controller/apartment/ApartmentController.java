...
import com.cse260.lease.model.enums.ReleaseStatus;
import com.cse260.lease.web.admin.service.ApartmentInfoService;
...
public class ApartmentController {
    ...
    public Result<ApartmentDetailVo> getDetailById(@RequestParam Long id) {
        ApartmentDetailVo result=service.getDetail(id);
        return Result.ok(result);
    }
