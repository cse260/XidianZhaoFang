package com.cse260.lease.web.app.controller.agreement;
...
import com.cse260.lease.web.app.service.LeaseAgreementService;
...
public class LeaseAgreementController {
    ...
    public Result<List<AgreementItemVo>> listItem() {
        //用户的username是它的手机号，租约表中存储的是手机号信息
...
//        updateWrapper.eq(LeaseAgreement::getId, id);
        updateWrapper.eq(LeaseAgreement::getPhone,phone);
